  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-2 left-10 text-white/20 text-xl animate-pulse"
          style={{ animationDelay: "0s", animationDuration: "3s" }}
        >
          ❄
        </div>
        <div
          className="absolute top-3 right-20 text-white/20 text-lg animate-pulse"
          style={{ animationDelay: "1s", animationDuration: "4s" }}
        >
          ❄
        </div>
        <div
          className="absolute top-2 left-1/3 text-white/20 text-base animate-pulse"
          style={{ animationDelay: "2s", animationDuration: "3.5s" }}
        >
          ❄
        </div>
        <div
          className="absolute top-3 right-1/4 text-white/20 text-xl animate-pulse"
          style={{ animationDelay: "1.5s", animationDuration: "4.5s" }}
        >
          ❄
        </div>
        <div
          className="absolute top-2 left-1/2 text-white/20 text-lg animate-pulse"
